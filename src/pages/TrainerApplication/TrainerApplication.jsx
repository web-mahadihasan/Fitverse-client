...
const schema = yup.object().shape({
  ...
  availableSlot: yup.array().of(yup.string()).optional(),
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="grid grid-cols-1 grid-rows-2">
            ...
            <div>
              <label
                ...
                className="block mb-2 text-sm font-medium text-gray-800 text-left dark:text-white"
              >
                Year of Experiecne (year)<span className="text-red-500">*</span>
              </label>
              <input
                type="number"
                {...register("experience")}
        ...
        <div>
          <label
            ...
            className="block mb-2 text-sm font-medium text-gray-800 text-left dark:text-white"
          >
            Total Available time a week (Hours)
        ...
        <div className="flex flex-col gap-[5px] w-full mt-[20px]">
          ...
          <textarea
            ...
            className="peer min-h-[100px] lg:w-full border-[#e5eaf2] border rounded-md outline-none px-4 py-3 w-full focus:border-main transition-colors duration-300 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
          ></textarea>
