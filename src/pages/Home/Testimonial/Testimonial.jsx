      ...
      <div className="glide-08 relative w-full">
        ...
        <div className="overflow-hidden" data-glide-el="track">
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0 pb-12">
            {
                testimonial && testimonial?.map((item, idx) => 
                    <li key={idx}>
                <div className="h-full w-full">
                  {/*                    <!-- Start Testimonial --> */}
                  <div className="h-full overflow-hidden rounded bg-white text-slate-500  shadow-xl">
                    <div className="relative p-6">
                      <figure className="relative z-10">
                        ...
                        <div>
                          ...
                          <div className="flex items-center justify-between w-full gap-4 pt-4 text-sm text-emerald-500">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="font-bold uppercase text-main font-poppins">
                                    {item?.name}
                                </span>
                                <cite className="not-italic text-gray-500 font-poppins font-medium dark:text-gray-400">
        ...
        {/*    <!-- Indicators --> */}
        <div
          className="absolute top-[100%] flex h-0 w-full items-center gap-6 px-4 "
          data-glide-el="controls"
        >
          <button
            className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-main/85 bg-white/20 text-main transition duration-300 hover:border-slate-900 hover:text-slate-900 focus-visible:outline-none lg:h-10 lg:w-10 dark:bg-gray-200"
            data-glide-dir="<"
            aria-label="prev slide"
          >
            <Icon icon="ri:arrow-left-double-fill" width="24" height="24" className="text-main"/>
          </button>
          <button
            className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-main/85 bg-white/20 text-main transition duration-300 hover:border-slate-900 hover:text-slate-900 focus-visible:outline-none lg:h-10 lg:w-10 dark:bg-gray-200"
            data-glide-dir=">"
          ...
          >
            <Icon icon="ri:arrow-right-double-fill" width="24" height="24" />
          </button>
        </div>
      </div>
