      ...
      <div className="max-w-7xl mx-auto px-4 xl:px-0 border-b border-gray-100">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="relative flex items-center gap-3">
            <button onClick={()=> setProfileMenu(!profileMenu)} type="button" className="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
